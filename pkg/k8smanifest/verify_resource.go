...
// verify a specified kubernetes resource
// signature must be provided for verification in some way like OCI image registry, annotations in the object or signature resource
