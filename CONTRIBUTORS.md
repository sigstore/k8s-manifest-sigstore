...
to make via an [issue](https://github.com/sigstore/k8s-manifest-sigstore/issues).

## Pull Request Process

1. Create an [issue](https://github.com/sigstore/k8s-manifest-sigstore/issues)
   outlining the fix or feature.
2. Fork the k8s-manifest-sigstore repository to your own github account and clone it locally.
...
7. Every pull request requires a review from the [core k8s-manifest-sigstore team](https://github.com/orgs/sigstore/teams/codeowners-k8s-manifest-sigstore/members)
   before merging.
...
k8s-manifest-sigstore adheres to and enforces the [Contributor Covenant](http://contributor-covenant.org/version/1/4/) Code of Conduct.
Please take a moment to read the [CODE_OF_CONDUCT.md](https://github.com/sigstore/k8s-manifest-sigstore/blob/master/CODE_OF_CONDUCT.md) document.
